...
\title{Complex-Valued Neural Networks for Prostate T2 MRI Classification: A Parameter-Matched Factorial Study}
...
\begin{IEEEkeywords}
complex-valued neural networks, prostate MRI, T2-weighted MRI, factorial design, Fourier-domain representation, PI-RADS, medical image classification
\end{IEEEkeywords}
